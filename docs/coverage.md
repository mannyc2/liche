...
See [env-vars.md](./env-vars.md) for the env var contract, [config-primitive.md](./config-primitive.md) for the config contract, [auth-session.md](./auth-session.md) for auth/session requirements, [build-system.md](./build-system.md) for build/generate requirements, and [release-and-distribution.md](./release-and-distribution.md) for release/manifest requirements.
