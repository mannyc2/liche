...
export const TARGETS: Record<string, TargetDescriptor> = {
  ...
  'linux-x64-musl-baseline': {
    id: 'linux-x64-musl-baseline',
    target: 'bun-linux-x64-musl-baseline' as CompileTarget,
    platform: 'linux',
    arch: 'x64',
    libc: 'musl',
    cpuVariant: 'baseline',
...
export const TARGET_PRESETS = {
  all: ['darwin-arm64', 'darwin-x64', 'linux-arm64', 'linux-arm64-musl', 'linux-x64', 'linux-x64-musl', 'windows-x64'],
  npm: ['darwin-arm64', 'darwin-x64', 'linux-arm64', 'linux-arm64-musl', 'linux-x64', 'linux-x64-musl', 'windows-x64'],
