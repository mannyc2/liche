...
function generate(catalog: Catalog): string {
  return generateCliFromCatalog(catalog, {
...
describe('generateCliFromCatalog — imports', () => {
...
describe('generateCliFromCatalog — command tree shape', () => {
...
describe('generateCliFromCatalog — run bodies by execution mode', () => {
...
describe('generateCliFromCatalog — list output resolution', () => {
...
describe('generateCliFromCatalog — dev is not treated as HTTP-capable', () => {
