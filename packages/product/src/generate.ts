...
function prepareGeneration(product: RuntimeProduct, options: GenerateToDirOptions): Prepared {
  ...
  const cliFileName = options.generatedFileName ?? 'liche.generated.ts'
  ...
  const openapiFileName = options.openapiFileName ?? 'liche.generated.openapi.json'
  const commandManifestSurfaceId = options.commandManifestSurfaceId ?? 'command-manifest'
  const commandManifestFileName = options.commandManifestFileName ?? 'liche.generated.commands.json'
  const mcpToolsSurfaceId = options.mcpToolsSurfaceId ?? 'mcp-tools'
  const mcpToolsFileName = options.mcpToolsFileName ?? 'liche.generated.mcp.json'
  const agentReferenceSurfaceId = options.agentReferenceSurfaceId ?? 'agent-reference'
  const agentReferenceFileName = options.agentReferenceFileName ?? 'liche.generated.agent.md'
  const docsReferenceSurfaceId = options.docsReferenceSurfaceId ?? 'docs-reference'
  const docsReferenceFileName = options.docsReferenceFileName ?? 'liche.generated.docs.md'
  const configSchemaSurfaceId = options.configSchemaSurfaceId ?? 'config-schema'
  const configSchemaFileName = options.configSchemaFileName ?? 'liche.generated.config.schema.json'
  const catalogSurfaceId = options.catalogSurfaceId ?? 'catalog'
  const catalogFileName = options.catalogFileName ?? 'liche.generated.catalog.json'
  const discoverySurfaceId = options.discoverySurfaceId ?? 'discovery'
  const discoveryFileName = options.discoveryFileName ?? 'liche.generated.discovery.json'
